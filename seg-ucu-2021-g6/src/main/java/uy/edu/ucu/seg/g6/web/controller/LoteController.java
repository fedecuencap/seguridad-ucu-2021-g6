...
//@RestController
public class LoteController /*extends BaseController*/ {

//	private Logger LOGGER = LoggerFactory.getLogger(getClass());
//
//	@RequestMapping(value = "/obtenerLote/", method = RequestMethod.GET)
//	public ResponseEntity<LoteDto> obtenerLote(@RequestParam(name = "id", required = true) Integer id) {
//
//		Contexto contexto = this.getContexto();
//
//		try {
//			LoteDto lote = businessFacade.findByIdLote(id);
//			if (lote == null) {
